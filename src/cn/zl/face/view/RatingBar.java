...
public class RatingBar {
    ...
    private static final int SHADOW_ALPHA = (int) (200 * 0.2); // 20%

    private static final int UN_RATING_ALPHA = (int) (200 * 0.3); // 30%

    private static final int RATING_ALPHA = (int) (200 * 1.0); // 100%

    private static final int OUTLINE_ALPHA = (int) (200 * 0.4); // 40%
    ...
    protected void drawRate(Canvas canvas, int index) {
        ...
        //ratedPaint.setColor(Color.YELLOW);
