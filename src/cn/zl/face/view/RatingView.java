...
public class RatingView extends FrameLayout {
    ...
    private static final long ROTATING_ANIMATION_DURATION = 2000L;

    private static final long RATING_ANIMATION_DURATION = 10L;

    private static final long TEXT_ANIMATION_DURATION = 10L;
    ...
    public RatingView(Context context, AttributeSet attrs) {
        ...
        mRatingBars = new ArrayList<RatingBar>();
	...
	private void initTextAnimation() {
        ...
        titleAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                textAlpha = (Integer) animation.getAnimatedValue();
                invalidate();
            }
        });
	...
	public void initRatingAnimation() {
        ratingAnimator = ValueAnimator.ofInt(0, 20);
        ratingAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                ratingGap =  (Integer) animation.getAnimatedValue();
                invalidate();
            }
        });
